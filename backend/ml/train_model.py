...
==========================
Phase 4 — ThreatLens ML Training Pipeline
...
def save_artifacts(
    ...
    # Metadata
    meta = {
        "model_name":    "ThreatLens Phishing URL Classifier",
        "model_version": "1.0.0",
        "phase":         4,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="ThreatLens Phase 4 — Model Training")
    parser.add_argument(
        "--no-download",
        action="store_true",
    ...
    print()
    print("=" * 60)
    print("  ThreatLens — Phase 4 Model Training Pipeline")
    print("=" * 60)
